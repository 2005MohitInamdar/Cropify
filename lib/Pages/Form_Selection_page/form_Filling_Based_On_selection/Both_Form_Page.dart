...
//
// class both_Form extends StatelessWidget {
//   const both_Form({super.key});
//
//   @override
...
//           children: [
//             Text("Both's Form Page"),
//             SizedBox(height: 20,),
//             ElevatedButton(
//                 onPressed: (){
//                   Navigator.push(context, MaterialPageRoute(builder: (context)=>form_Selector_Page()));
//                 },
//                 child: Text("Submit"),
...
import '../../Dealer_Home_Page/Dealer_Navigation.dart';
import '../../both_Home_Page/both_navigation.dart';


class bothRegistrationForm extends StatefulWidget {
  @override
  _bothRegistrationFormState createState() => _bothRegistrationFormState();
}

class _bothRegistrationFormState extends State<bothRegistrationForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Both Registration")),
      body: Padding(
