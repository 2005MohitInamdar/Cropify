import 'package:demomain/Pages/Farmer_Home_Pages/Farmer%20messenger/farmer_dealer_worldwide_chat.dart';
import 'package:flutter/material.dart';
import 'farmer_farmer_worldwide_chat.dart';
import 'farmer_private_messenger.dart';

class farmerMessengerNavigationPage extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<farmerMessengerNavigationPage> {
  // Track the selected page index
  int _selectedIndex = 0;

  // List of pages to be displayed based on selection
  final List<Widget> _pages = [
    Center(child: farmer_farmer_worldwide_chat()), // Page 1 content
    Center(child: farmer_dealer_worldwide_chat()), // Page 2 content
    Center(child: farmer_private_chat()), // Page 3 content
  ];
      ...
      body: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                _buildNavButton("Seller", 0),
                _buildNavButton("Buyer", 1),
