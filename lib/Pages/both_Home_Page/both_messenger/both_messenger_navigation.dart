...
class BothMessengerNavigationPage extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<BothMessengerNavigationPage> {
      ...
      body: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                _buildNavButton("Farmer", 0),
                _buildNavButton("Dealer", 1),
